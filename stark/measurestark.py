...
def measure_spectrum(wavl, flux, ivar, i, lines = ['a','b','g','d'], lte_mask_size = 8, nlte_core_size = 15, modeltype='1d_da_nlte'):
    ...
    lte_figure = corv.utils.lineplot(wavl[ltemask], flux[ltemask], ivar[ltemask], ltemodel, lte_param_res.params)
    #nlte_figure = corv.utils.lineplot(wavl, flux, ivar, nltemodel, nlte_param_res.params)
    ...
    return results, lte_figure#, nlte_figure